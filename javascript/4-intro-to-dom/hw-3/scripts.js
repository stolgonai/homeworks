...
let myBooks = [
  ...
  // var = you can get acces to them from the other scope and you can simply declare with same var.Name
  // let vars can be accessible in global and local scopes, and it will not give allowed to create a same variable, but it can be chageble in future.
  //const it is constant variable, so it is more securable declaring of variable, BUT, if you decided to change it later, it will not give that oportunity, so u need to change your declarition, anfd than make some changes.
