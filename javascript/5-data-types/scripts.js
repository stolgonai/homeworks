...
function findEven(arr){
  ...
  //   return false
  // }
  // include("I eat apple", "apple");
  // // include("I eat apple");
  // // include("I eat apple", " banana")
  
  // ///////////////////////////////////////////////
  // function stringLastIndexOf (str, char) {
  //   if(char === undefined){
  //     return "Character is undefined"
  //   }
  ...
  // }
  // stringLastIndexOf("book", "k")
  // stringLastIndexOf("book")
  
  // /////////////////////////////////////////
  // function countChar(str, char){
  //   var count = 0;
  //   if(char === undefined){
  //     return count + ", char not defined"
  //   }
